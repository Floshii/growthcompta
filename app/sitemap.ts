...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${siteUrl}/facturation-electronique-2026`, lastModified: new Date(), changeFrequency: 'weekly',  priority: 0.8 },
    { url: `${siteUrl}/onboarding-client`,            lastModified: new Date(), changeFrequency: 'weekly',  priority: 0.8 },
    { url: `${siteUrl}/payback-period`,              lastModified: new Date(), changeFrequency: 'weekly',  priority: 0.8 },
