...
export const faqItems = [
  {
    q: 'Est-ce que ça remplace Pennylane ?',
  ...
  },
  {
    ...
    a: "30 jours ouvrés après le kick-off pour un portail configuré, brandé et testé sur un premier dossier réel. C'est la garantie qu'on donne.",
  },
  {
    q: 'C\'est quoi exactement "marque blanche" ?',
    a: "Votre client ne voit aucune mention de GrowthCompta. Il accède à un portail à votre domaine (ex : onboarding.votrecabinet.fr), à vos couleurs, avec votre logo. L'expérience est entièrement à votre enseigne.",
  },
  {
    q: 'Est-ce que vos équipes touchent aux données de mes clients ?',
    a: "Non. Le portail collecte et structure les pièces. Les données restent dans votre environnement. On ne manipule jamais de mots de passe ni d'accès sensibles directement.",
  },
  {
