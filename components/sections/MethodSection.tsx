const phases = [
  ...
  },
  {
    ...
    items: [
      ...
      'LinkedIn full branding + lead magnet niche',
      'SEO programmatique + 10 articles',
      'Agent vocal IA + système d\'avis Google',
      'Script de vente & process de closing',
    ],
    price: '7 000€',
    priceDetail: '→ 6 000€ si upsell depuis FIRE',
    highlight: null,
  },
  {
    id: '03',
